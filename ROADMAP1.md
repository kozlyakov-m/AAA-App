...
(args[0]=="-login" && args[2]=="-pass")
 ...
 8. Добавляем метод проверки вложенности ресурса (используем `substring(0,res.length)`)
 ...
 11. В метод авторизации добавить вызов метода 5.7, а из него 5.8
 12. В метод поиска ресурса добавить флаг "доступ получен"
 13. 
