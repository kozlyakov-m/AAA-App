...
(args[0]=="-login" && args[2]=="-pass")
 ...
 #### 5. Авторизация
 1. Если не нужна авторизация при успешной аутентификации,   
 то заканчиваем программу с кодом 0
 2. Иначе запускаем авторизацию
 ...
 8. Добавляем метод проверки вложенности ресурса (используем find)
