...
4. **Аутентификация - 105 минут** 
 ...
 5. **Авторизация - 1	50 минут**
    ...
    11. Добавляем метод проверки вложенности ресурса в `BusinessLogic` (используем   
     `substring(0,res.length)`) (**R1.6, R1.4**) - 10 минут
        + (Если ресурс из таблицы является началом требуемого  
        ресурса, предоставить доступ)
    12. Создать метод авторизации в `BusinessLogic` - 10 минут
    13. В метод авторизации добавить вызов метода 5.7, а из него 5.8 - 10 минут
    14. В метод поиска ресурса добавить флаг `доступ получен` (**R1.6**) - 10 минут
    15. Дополнить справку - 10 минут
